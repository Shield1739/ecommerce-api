...
describe('Product Routes', () => {
  ...
  describe('POST /api/products', () => {
    ...
    it('should return error when category does not exist', async () => {
        ...
        expect(response.body.error).toEqual("Category with id " + categoryId + " does not exist")
  ...
  describe('GET /api/products/category/:categoryId', () => {
    it('should return products for category', async () => {
        ...
        await Product.bulkCreate([
            { name: 'Product A',  description: 'Product A', price: 100, inventory: 20, taxRate: 0, categoryId: category1.id },
            { name: 'Product B',  description: 'Product B', price: 100, inventory: 20, taxRate: 0, categoryId: category1.id },
            { name: 'Product C',  description: 'Product C', price: 100, inventory: 20, taxRate: 0, categoryId: category2.id }
        ]);
